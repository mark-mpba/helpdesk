...
return [
    'connections' => [
        'ibmi' => [
            ...
            'odbc_driver' => '/QOpenSys/pkgs/lib/libcwbodbc.so',
            'dsn' => 'Driver={IBM i Access ODBC Driver};System=localhost;AlwaysCalculateResultLength=1;CCSID=1208;NAM=1;DBQ=,'.env('DBQ'),
            'host' => env('DB_HOST', 'localhost'),
            'database' => env('DB_DATABASE'),
            'username' => env('DB_USERNAME'),
            'password' => env('DB_PASSWORD'),
            'prefix' => '',
            'schema' => env('DB_DATABASE', 'AAMEDIUK'),
            'port' => 50000,
        ...
        'ibmi_osx' => [
            ...
            'driverName' => '{IBM i Access ODBC Driver}',
            'odbc_driver' => '/Library/IBMiAccess/lib/libcwbodbc.dylib',
            'dsn' => 'Driver={IBM i Access ODBC Driver 64-bit};System='.env('DB_HOST').';AlwaysCalculateResultLength=1;CCSID=1208;NAM=1;DBQ=,'.env('DBQ'),
            'host' => env('DB_HOST', 'localhost'),
            'database' => env('DB_DATABASE','AAMEDIUK'),
            'username' => env('DB_USERNAME'),
            'password' => env('DB_PASSWORD'),
            'prefix' => '',
            'schema' => env('DB_DATABASE', 'AAMEDIUK'),
