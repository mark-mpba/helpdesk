...
Route::group(['middleware' => LaravelVersion::authMiddleware()], function () use ($main_route, $main_route_path, $admin_route, $admin_route_path) {
    //Ticket public route
    ...
    Route::group(['middleware' => '\mpba\Tickets\Middleware\IsAgentMiddleware'], function () use ($main_route, $main_route_path) {
    ...
    Route::group(['middleware' => '\mpba\Tickets\Middleware\IsAdminMiddleware'], function () use ($admin_route, $admin_route_path) {
