...
<div class="container">
    <h1 style="text-align: center">{{ trans('ticket::install.upgrade') }}</h1>
    <br>
    ...
    <div class="well small" style="border: 1px solid #ccc">
        @if(!empty($inactive_settings))
            <b>{{ trans('ticket::install.settings-to-be-installed') }}</b>
            <ul>
        ...
        @else
            <b>{{ trans('ticket::install.all-settings-installed') }}</b>
        @endif
    </div>
    <br>
