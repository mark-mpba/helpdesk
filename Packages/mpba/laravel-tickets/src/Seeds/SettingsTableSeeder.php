...
class SettingsTableSeeder extends Seeder
{
    ...
    /**
     * Takes config/ticket.php, merge with package defaults, and returns serialized array.
     *
     *
     * @return array
     */
    ...
    public function getDefaults()
    {
        return [
            ...
            /*
             * Ticket main route: Where to load the ticket system (ex. http://url/tickets)
             * Default: /ticket
             */
            'main_route' => 'tickets',
            'main_route_path' => 'tickets',
            /*
             * Tickets admin route: Where to load the ticket administration dashboard (ex. http://url/tickets-admin)
             * Default: /ticket
             */
             ...
             * Default: ticket::emails.templates.ticketit
             */
            'email.template' => 'ticket::emails.templates.tickets',
            ...
            'email.footer' => 'Powered by Larvel Tickets',
            'email.footer_link' => 'https://helpdesk.digiqrp.com',
            ...
            /*
             * Whether include codemirror syntax highlighter or not
             ...
             */
            'summernote_options_json_file' => 'vendor/mpba/laravel-tickets/src/JSON/summernote_init.json',
             ...
             * The same config can be archived by running php artisan vendor:publish and modifying config/purifier.php
             *
             ...
             */
            'routes' => base_path('vendor/mpba/laravel-ticket/src').'/routes.php',
